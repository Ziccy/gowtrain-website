...
export default function SpelerLoginPage() {
  ...
  async function getPlayerRole(userId: string): Promise<PlayerLoginResult> {
    ...
    if (profileError) {
      console.error("Spelerprofiel controleren fout:", profileError.message);
  ...
  async function handleLogin(): Promise<void> {
    ...
    try {
      ...
      if (result === "admin") {
        await supabase.auth.signOut();
        showError("Dit is een beheerderaccount. De beheeromgeving is nog niet beschikbaar op het web.");
        return;
      }
  ...
  async function handleForgotPassword(): Promise<void> {
    ...
    try {
      ...
      if (error) {
        console.error("Speler wachtwoordherstel fout:", error.message);
        showError("De resetlink kon niet worden verstuurd. Probeer het later opnieuw.");
        return;
      }
      ...
      console.error("Onverwachte wachtwoordherstel fout:", error);
      showError("De resetlink kon niet worden verstuurd. Probeer het later opnieuw.");
    } finally {
      setLoading(false);
    }
          ...
          <div className="lg:self-center">
            ...
            {cameFromBooking && !isForgotPassword ? (
              <div className="mt-8 border-2 border-[#D6FF3F] bg-[#14171A] p-4 shadow-[5px_5px_0_0_#D6FF3F]">
                <p className="font-display text-lg text-[#D6FF3F]">⚡ BIJNA KLAAR</p>
              ...
              <div className="mt-10 border-l-2 border-[#D6FF3F] pl-5">
                <p className="font-display text-2xl text-[#D6FF3F]">JOUW TRAINING. JOUW MOMENT.</p>
            ...
            <div className="mt-10 hidden border-t border-white/20 pt-6 lg:block">
              <p className="font-display text-lg text-white">NOG GEEN SPELERACCOUNT?</p>
            ...
            <div className="bg-[#14171A] p-5 sm:p-8">
              ...
              {!isForgotPassword && (
                <div className="mt-8 border-t border-white/20 pt-6 text-center">
                  <p className="text-sm text-[#B9BEC2]">Nog geen speleraccount?</p>
                  <a
                    href={registerHref}
